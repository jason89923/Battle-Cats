...
class Cat(App_base):
    ...
    def __init__(self):
        super().__init__()
        self._click_map['開始遊戲'] = (956, 533)
        self._click_map['章節'] = (956, 533)
        self._click_map['OK'] = (1185, 538)
        self._click_map['進入加碼多多'] = (301, 673)
        self._click_map['加碼多多'] = (800, 572)
        self._click_map['深度探險'] = (980, 591)
        self._click_map['深度探險_是'] = (603, 640)
        self._click_map['空白'] = (818, 37)
        self._click_map['領取獎勵'] = (1332, 119)
        self._click_map['取消'] = (1199, 139) 
        self._click_map['整隊'] = (1364, 137) 
        ...
        self._click_map['離隊_取消'] = (1378, 313)
        self._click_map['離隊'] = (386, 626)
        self._click_map['離隊_是'] = (693, 659)

        self._click_map['新隊員'] = (83, 591) 
        self._click_map['skip'] = (1417, 821)
        self._click_map['神社'] = (345, 415)
        self._click_map['100萬'] = (658, 580)
        self._click_map['返回'] = (83, 819)
        
        self._click_map['關閉廣告'] = (1379, 53)
        
        # 轉蛋
        self._click_map['轉蛋'] = (1271, 721)
        self._click_map['轉蛋_是'] = (661, 591)
        self._click_map['轉蛋_ok'] = (1253, 744)
        self._click_map['轉蛋_結束'] = (1044, 578)
...
if CONFIG == '':
    COLOR_MAP = {
        ...
        '轉蛋結束': Triple_Pixel_Info((855,590), '181C1D', (949,589), '191C1D', (1067,590), '181C1D')
    }
else:
...
def corruptRecovery(need_reboot=False):
    ...
    for i in range(3):
        ...
        if not check_Pixel_Info.check('VPN', 1000):
            send_command(Commands.App.VPN.click('switch'))
        send_command(Commands.App.VPN.click('switch'))

        send_command(Commands.Time.set_date)
        
        send_command(Commands.App.CAT.open, 1000)
    ...
    while check_Pixel_Info.check('加碼多多圖示', 50):
        ...
        send_command(Commands.App.CAT.click('關閉廣告'))
        i = i + 1
        if i >= 30:
            raise Exception('corrupt recovery')
...
def shrine(reset=True):
    if reset:
        ...
        i = 0
        while check_Pixel_Info.check('加碼多多圖示', 100):
            send_command(Commands.App.CAT.click('關閉廣告'))
            if i == 30:
                return
...
def auto_roll():
    ...
    while True:
        send_command(Commands.App.CAT.click('轉蛋'), 1000)
        send_command(Commands.App.CAT.click('轉蛋_是'), 1000)
        while check_Pixel_Info.check('轉蛋結束'):
            send_command(Commands.App.CAT.click('轉蛋_ok'), 400)
        for _ in range(4):
            send_command(Commands.App.CAT.click('轉蛋_結束'), 600)
